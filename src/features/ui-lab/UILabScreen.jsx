...
export default function UILabScreen() {
  ...
  const [navPreview, setNavPreview] = useState('account');
  ...
  return (
    <AppBackground>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <LabSection number="09" title="Navegación inferior" caption="Cinco accesos persistentes con selector móvil y estado activo elevado.">
...
const styles = StyleSheet.create({
  ...
  hero: { marginTop: 31, padding: 22, borderRadius: 27, backgroundColor: '#E8EEFF', borderWidth: 1.5, borderColor: '#FFFFFF', shadowColor: '#A8B7DE', shadowOpacity: .62, shadowRadius: 16, shadowOffset: { width: 8, height: 9 }, elevation: 7 }, heroTitle: { color: COLORS.ink, fontFamily: FONTS.heading, fontSize: 25, lineHeight: 30 }, heroCopy: { marginTop: 10, color: COLORS.muted, fontFamily: FONTS.body, fontSize: 10, lineHeight: 16, maxWidth: 265 }, replay: { alignSelf: 'flex-start', flexDirection: 'row', gap: 7, alignItems: 'center', marginTop: 18, paddingHorizontal: 15, paddingVertical: 11, borderRadius: 14, shadowColor: '#8D9CD0', shadowOpacity: .55, shadowRadius: 7, shadowOffset: { width: 3, height: 4 }, elevation: 4 }, replayText: { color: 'white', fontFamily: FONTS.button, fontSize: 11 }, motionFeedback: { marginTop: 10, color: COLORS.muted, fontFamily: FONTS.button, fontSize: 8 },
  ...
  buttonGrid: { flexDirection: 'row', gap: 10 }, primaryButton: { flex: 1, height: 52, borderRadius: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 1, borderColor: '#FFFFFF', shadowColor: COLORS.blue, shadowOpacity: .31, shadowRadius: 9, shadowOffset: { width: 4, height: 6 }, elevation: 5 }, primaryText: { color: 'white', fontFamily: FONTS.button, fontSize: 12 }, secondaryButton: { flex: 1, height: 52, borderRadius: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 1.5, borderColor: '#FFFFFF', backgroundColor: '#EEF3FF', shadowColor: '#B5C2E2', shadowOpacity: .38, shadowRadius: 7, shadowOffset: { width: 3, height: 4 }, elevation: 3 }, buttonDown: { opacity: .82, transform: [{ scale: .97 }] }, secondaryText: { fontFamily: FONTS.button, fontSize: 12 }, modalTrigger: { marginTop: 10, height: 49, paddingHorizontal: 14, borderRadius: 16, flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1.5, borderColor: '#FFFFFF', backgroundColor: '#F0F4FF', shadowColor: '#BBC7E5', shadowOpacity: .32, shadowRadius: 6, shadowOffset: { width: 3, height: 4 }, elevation: 3 }, modalTriggerText: { flex: 1, fontFamily: FONTS.button, fontSize: 11 }, iconRail: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 14 }, iconTile: { width: '22%', paddingVertical: 13, alignItems: 'center', gap: 6, borderRadius: 16, backgroundColor: '#F0F4FF', borderWidth: 1, borderColor: '#FFFFFF', shadowColor: '#BCC8E6', shadowOpacity: .3, shadowRadius: 5, shadowOffset: { width: 3, height: 3 }, elevation: 2 }, iconLabel: { color: COLORS.muted, fontFamily: FONTS.button, fontSize: 8 },
  search: { height: 50, borderRadius: 16, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 9, borderWidth: 1.5, backgroundColor: '#EAF0FE', shadowColor: '#AEBBDB', shadowOpacity: .24, shadowRadius: 5, shadowOffset: { width: 2, height: 3 }, elevation: 2 }, searchInput: { flex: 1, color: COLORS.ink, fontFamily: FONTS.body, fontSize: 11, height: '100%' }, filterRow: { flexDirection: 'row', gap: 8, marginTop: 11 }, chip: { paddingHorizontal: 14, paddingVertical: 9, borderRadius: 14, backgroundColor: '#EEF3FF', borderWidth: 1, borderColor: '#FFFFFF', shadowColor: '#C0CBE7', shadowOpacity: .24, shadowRadius: 4, shadowOffset: { width: 2, height: 3 }, elevation: 2 }, chipText: { color: COLORS.muted, fontFamily: FONTS.button, fontSize: 10 }, chipTextSelected: { color: 'white' }, controlRow: { marginTop: 14, padding: 14, borderRadius: 18, backgroundColor: '#EEF3FF', borderWidth: 1.5, borderColor: '#FFFFFF', shadowColor: '#B3C0E0', shadowOpacity: .35, shadowRadius: 8, shadowOffset: { width: 4, height: 5 }, elevation: 4, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, controlTitle: { color: COLORS.ink, fontFamily: FONTS.button, fontSize: 11 }, controlCopy: { marginTop: 3, color: COLORS.muted, fontFamily: FONTS.body, fontSize: 8 }, selectGroup: { marginTop: 12, gap: 8 }, selectOption: { paddingHorizontal: 13, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', gap: 9, borderWidth: 1.5, borderColor: '#FFFFFF', borderRadius: 14, backgroundColor: '#F0F4FF', shadowColor: '#C0CBE6', shadowOpacity: .24, shadowRadius: 4, shadowOffset: { width: 2, height: 3 }, elevation: 2 }, selectOptionActive: { backgroundColor: '#E6ECFF', borderColor: '#FFFFFF', shadowOpacity: .42, shadowRadius: 6, shadowOffset: { width: 3, height: 4 }, elevation: 4 }, radio: { width: 18, height: 18, borderRadius: 9, borderWidth: 1.5, borderColor: '#BBC6E0', alignItems: 'center', justifyContent: 'center' }, radioDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: 'white' }, selectText: { color: COLORS.ink, fontFamily: FONTS.bodyMedium, fontSize: 10 },
