...
const styles = StyleSheet.create({
  ...
  hero: { minHeight: 320, paddingHorizontal: 24, paddingTop: 15, backgroundColor: COLORS.violet, borderBottomLeftRadius: 42, borderBottomRightRadius: 42, shadowColor: '#5B40DE', shadowOpacity: .3, shadowRadius: 17, shadowOffset: { width: 0, height: 8 }, elevation: 7 },
