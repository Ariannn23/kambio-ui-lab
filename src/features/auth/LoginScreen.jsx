...
const styles = StyleSheet.create({
  ...
  heroMessage: { marginTop: 55 }, eyebrow: { color: '#BFD0FF', fontFamily: FONTS.button, fontSize: 9, letterSpacing: 1.1 }, heroTitle: { marginTop: 11, color: 'white', fontFamily: FONTS.heading, fontSize: 30, lineHeight: 35 }, heroCopy: { marginTop: 9, color: '#D7E2FF', fontFamily: FONTS.body, fontSize: 11, lineHeight: 17 },
  ...
  divider: { flexDirection: 'row', alignItems: 'center', gap: 9, marginTop: 2 }, dividerLine: { flex: 1, height: 1, backgroundColor: '#DCE3F4' }, dividerText: { color: COLORS.muted, fontFamily: FONTS.button, fontSize: 8, letterSpacing: .7 }, biometricButton: { marginTop: 17, padding: 15, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: 20, backgroundColor: '#EDF1FF', borderWidth: 1.5, borderColor: '#FFFFFF', shadowColor: '#C0CBE6', shadowOpacity: .3, shadowRadius: 6, shadowOffset: { width: 3, height: 4 }, elevation: 3 }, fingerprint: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 17, backgroundColor: '#E1E6FF' }, biometricTitle: { color: COLORS.ink, fontFamily: FONTS.button, fontSize: 13 }, biometricCopy: { marginTop: 3, color: COLORS.muted, fontFamily: FONTS.body, fontSize: 10 }, notice: { minHeight: 19, marginTop: 15, textAlign: 'center', color: COLORS.muted, fontFamily: FONTS.body, fontSize: 10 },
  pressed: { transform: [{ scale: .97 }], opacity: .9 }, modalBackdrop: { flex: 1, padding: 24, justifyContent: 'center', backgroundColor: 'rgba(16,26,75,.32)' }, helpCard: { padding: 23, borderRadius: 27, backgroundColor: '#EEF3FF', borderWidth: 1.5, borderColor: '#FFFFFF', shadowColor: '#243263', shadowOpacity: .25, shadowRadius: 18, shadowOffset: { width: 7, height: 9 }, elevation: 9 }, helpIcon: { width: 50, height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 17, backgroundColor: '#E0E7FF' }, helpTitle: { marginTop: 17, color: COLORS.ink, fontFamily: FONTS.heading, fontSize: 21 }, helpCopy: { marginTop: 8, color: COLORS.muted, fontFamily: FONTS.body, fontSize: 10, lineHeight: 16 }, helpClose: { alignSelf: 'flex-end', marginTop: 20, paddingVertical: 12, paddingHorizontal: 18, borderRadius: 14, backgroundColor: COLORS.blue }, helpCloseText: { color: 'white', fontFamily: FONTS.button, fontSize: 11 },
});
