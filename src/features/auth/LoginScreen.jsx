...
const styles = StyleSheet.create({
  ...
  loginButton: { height: 56, marginTop: 26, borderRadius: 17, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, backgroundColor: COLORS.blue, borderWidth: 1, borderColor: '#FFFFFF', shadowColor: '#021DE8', shadowOpacity: .34, shadowRadius: 10, shadowOffset: { width: 4, height: 6 }, elevation: 6 }, loginDisabled: { backgroundColor: '#9EA8D5', shadowOpacity: .1 }, loginText: { color: 'white', fontFamily: FONTS.button, fontSize: 13 }, recoveryButton: { alignSelf: 'center', paddingVertical: 16 }, recoveryText: { color: COLORS.blue, fontFamily: FONTS.button, fontSize: 11 },
