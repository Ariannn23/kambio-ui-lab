...
export default function Transfers() {
  ...
  return <Screen>
    ...
    <Pressable style={({ pressed }) => [styles.sendButton, pressed && styles.sendButtonPressed]}><Text style={styles.sendText}>Enviar {numericAmount ? `S/ ${numericAmount.toFixed(2)}` : 'transferencia'}</Text><View style={styles.sendIcon}><KambioIcon name="send-outline" size={20} color="white" /></View></Pressable>
